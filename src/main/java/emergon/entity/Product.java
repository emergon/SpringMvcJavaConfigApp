...
@NamedQueries(value = {
    ...
    @NamedQuery(name = "Product.findById", query = "SELECT p FROM Product p WHERE p.pcode = :id"),
    @NamedQuery(name = "Product.deleteById", query = "DELETE FROM Product p WHERE p.pcode = :id")
})
