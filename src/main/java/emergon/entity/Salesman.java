...
@NamedQueries({
    ...
    , @NamedQuery(name = "Salesman.findById", query = "SELECT s FROM Salesman s WHERE s.scode = :id")
    ...
    , @NamedQuery(name = "Salesman.deleteById", query = "Delete from Salesman s where s.scode = :id")
})
